...
#ifndef _VULKAN_RENDER_PASS_DESCRIPTOR_MANAGER_H_
#define _VULKAN_RENDER_PASS_DESCRIPTOR_MANAGER_H_

#include "VulkanPreDefine.h"

namespace LostPeterPluginRendererVulkan
{
    class VulkanRenderPassDescriptorManager : public RenderPassDescriptorManager
    {
    public:
        VulkanRenderPassDescriptorManager(VulkanDevice* pDevice);
        virtual ~VulkanRenderPassDescriptorManager();
