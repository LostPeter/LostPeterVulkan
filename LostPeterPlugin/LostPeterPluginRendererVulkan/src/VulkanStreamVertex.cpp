...
namespace LostPeterPluginRendererVulkan
{
    ...
    {
        F_Assert(pDevice && "VulkanStreamVertex::VulkanStreamVertex")
        createVkBuffer();
    ...
    VulkanStreamVertex::~VulkanStreamVertex()
    {
        F_DELETE(m_pStreamShadow)
        destroyVkBuffer();
    }

    void VulkanStreamVertex::destroyVkBuffer()
    {
    ...
    void VulkanStreamVertex::createVkBuffer()
    {
        destroyVkBuffer();
        ...
        if (!m_pDevice->CreateVkBuffer(m_nStreamSizeInBytes,
                                       ...
                                       m_vkDeviceMemory))
        {
            F_LogError("*********************** VulkanStreamVertex::createVkBuffer: CreateVkBuffer failed !");
        }
    }
	...
	void VulkanStreamVertex::unlockImpl()
    {
        F_Assert(!m_pStreamShadow && "VulkanStreamVertex::unlockImpl: Should be handled by UpdateFromShadow !")
