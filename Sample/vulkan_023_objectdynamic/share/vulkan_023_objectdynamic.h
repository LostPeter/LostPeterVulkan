...
#ifndef _VULKAN_023_OBJECT_DYNAMIC_H_
#define _VULKAN_023_OBJECT_DYNAMIC_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeterVulkan; 

class Vulkan_023_ObjectDynamic : public VulkanWindow
{
public:
    Vulkan_023_ObjectDynamic(int width, int height, String name);
...
public:
    ...
    {
        //Window
        Vulkan_023_ObjectDynamic* pWindow;
        int index;
        ...
        ModelObject(Vulkan_023_ObjectDynamic* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
