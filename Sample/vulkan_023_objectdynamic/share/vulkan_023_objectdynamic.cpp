...
void Vulkan_023_ObjectDynamic::destroyShaders()
{   
...
void Vulkan_023_ObjectDynamic::createShaders()
{
    for (int i = 0; i < g_ShaderCount; i++)
    {
        ...
        F_LogInfo("Vulkan_023_ObjectDynamic::createShaders: create shader, name: [%s], type: [%s], path: [%s] success !", 
                  shaderName.c_str(), shaderType.c_str(), shaderPath.c_str());
    }
}
VKShader* Vulkan_023_ObjectDynamic::findShader(const String& nameShader)
{
