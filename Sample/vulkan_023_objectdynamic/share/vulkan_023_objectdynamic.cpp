...
void Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::CleanupSwapChain()
{
    size_t count = 0;
...
void Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::SetupVertexIndexBuffer(const ModelObjectRendPtrVector& _aRends)
{
    F_Assert(_aRends.size() > 0 && "Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::SetupVertexIndexBuffer")
    this->aRends.clear();
    this->aRends = _aRends;
    ...
    {
        F_Assert(false && "Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::SetupVertexIndexBuffer: No vertex data !")
    }
...
void Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::SetupUniformIndirectCommandBuffer()
{
    ...
    //1> Uniform Buffer
    {
		...
		if (this->poBuffers_ObjectCB.size() <= 0)
		{
			for (size_t j = 0; j < count_sci; j++) 
			{
				...
				if (!pBufferUniform)
				{
					String msg = "*********************** Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::SetupUniformIndirectCommandBuffer: create buffer uniform: [" + nameBuffer + "] failed !";
    ...
    //2> IndirectCommand Buffer
    {
		...
		{
			String msg = "*********************** Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::SetupUniformIndirectCommandBuffer: create buffer indirect command: [" + nameBuffer + "] failed !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg);
		}
    }
...
void Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::UpdateUniformBuffer()
{
    int count_index = 0;
    size_t count_rend = this->aRends.size();
    for (size_t i = 0; i < count_rend; i++)
...
void Vulkan_023_ObjectDynamic::ModelObjectRendIndirect::UpdateIndirectCommandBuffer()
{
    this->indirectCommandCBs.clear();
...
Vulkan_023_ObjectDynamic::Vulkan_023_ObjectDynamic(int width, int height, String name)
...
void Vulkan_023_ObjectDynamic::setUpEnabledFeatures()
{
    ...
    else
    {
        ...
        F_LogError("*********************** Vulkan_023_ObjectDynamic::setUpEnabledFeatures: multiDrawIndirect is not supported !");
    }
}

void Vulkan_023_ObjectDynamic::createDescriptorSetLayout_Custom()
{
    VulkanWindow::createDescriptorSetLayout_Custom();
}

void Vulkan_023_ObjectDynamic::createCamera()
{
    this->pCamera = new FCamera();
    cameraReset();
}
void Vulkan_023_ObjectDynamic::cameraReset()
{
...
void Vulkan_023_ObjectDynamic::loadModel_Custom()
{
    createMeshes();
    createTextures();
    ...
    for (int i = 0; i < g_Object_Count; i++)
    {
        ...
        //1> Object
        {
            ...
            //Mesh
            {
                ...
                F_Assert(pMesh != nullptr && "Vulkan_023_ObjectDynamic::loadModel_Custom")
        ...
        //2> ObjectRend
        {
            ...
            for (size_t j = 0; j < count_mesh_sub_used; j++)
            {
                ...
                F_Assert(indexMeshSub >= 0 && indexMeshSub < count_mesh_sub && "Vulkan_023_ObjectDynamic::loadModel_Custom")
...
void Vulkan_023_ObjectDynamic::createIndirectCommands()
{

}

void Vulkan_023_ObjectDynamic::createCustomCB()
{
    rebuildInstanceCBs(true);
}
void Vulkan_023_ObjectDynamic::rebuildInstanceCBs(bool isCreateVkBuffer)
{   
    VkDeviceSize bufferSize;
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        if (isCreateVkBuffer)
        {
            ...
            for (size_t j = 0; j < count_sci; j++) 
            {
				...
				if (!pBufferUniform)
				{
					String msg = "*********************** Vulkan_023_ObjectDynamic::createCustomCB: create buffer uniform: [" + nameBuffer + "] failed !";
					F_LogError(msg.c_str());
					throw std::runtime_error(msg);
				}
...
void Vulkan_023_ObjectDynamic::createCustomBeforePipeline()
{
...
void Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom()
{
    //1> Viewport
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            String msg = "*********************** Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Can not find shader used !";
            F_LogError(msg.c_str());
        ...
        //[2] Pipeline Graphics
        {
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Can not find DescriptorSetLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Can not find PipelineLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Failed to create pipeline graphics wire frame: " + pRend->nameObjectRend;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            F_LogInfo("Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics wire frame success !", pRend->nameObjectRend.c_str());
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Failed to create pipeline graphics: " + pRend->nameObjectRend;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            F_LogInfo("Vulkan_023_ObjectDynamic::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics graphics success !", pRend->nameObjectRend.c_str());
        }
    }
}
void Vulkan_023_ObjectDynamic::createComputePipeline_Custom()
{
    size_t count_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            String msg = "*********************** Vulkan_023_ObjectDynamic::createComputePipeline_Custom: Can not find shader used !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            String msg = "*********************** Vulkan_023_ObjectDynamic::createComputePipeline_Custom: Pipeline count is not equal shader count !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        for (size_t j = 0; j < count_pipeline; j ++)
        {
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createComputePipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createComputePipeline_Custom: Can not find DescriptorSetLayout by name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createComputePipeline_Custom: Can not find PipelineLayout by name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createComputePipeline_Custom: Create compute pipeline failed, PipelineLayout name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
...
void Vulkan_023_ObjectDynamic::destroyMeshes()
{
...
void Vulkan_023_ObjectDynamic::createMeshes()
{
    for (int i = 0; i < g_MeshCount; i++)
    {
        ...
        {
            String msg = "*********************** Vulkan_023_ObjectDynamic::createMeshes: create mesh: [" + nameMesh + "] failed !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg);
        }
        ...
        F_LogInfo("Vulkan_023_ObjectDynamic::createMeshes: create mesh: [%s], vertex type: [%s], mesh type: [%s], geometry type: [%s], mesh sub count: [%d], path: [%s] success !", 
                  nameMesh.c_str(), nameVertexType.c_str(), nameMeshType.c_str(), nameGeometryType.c_str(), (int)pMesh->aMeshSubs.size(), pathMesh.c_str());
    }
}
Mesh* Vulkan_023_ObjectDynamic::findMesh(const String& nameMesh)
{
...
void Vulkan_023_ObjectDynamic::destroyTextures()
{
...
void Vulkan_023_ObjectDynamic::createTextures()
{
    for (int i = 0; i < g_TextureCount; i++)
    {
        ...
        F_LogInfo("Vulkan_023_ObjectDynamic::createTextures: create texture: [%s], type: [%s], isRT: [%s], path: [%s] success !", 
                  nameTexture.c_str(), 
                  nameType.c_str(), 
...
VKTexture* Vulkan_023_ObjectDynamic::findTexture(const String& nameTexture)
{
...
void Vulkan_023_ObjectDynamic::destroyDescriptorSetLayouts()
{
...
void Vulkan_023_ObjectDynamic::createDescriptorSetLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayoutCount; i++)
    {
        ...
        {
            String msg = "*********************** Vulkan_023_ObjectDynamic::createDescriptorSetLayouts: Failed to create descriptor set layout: " + nameLayout;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg);
        }
        ...
        F_LogInfo("Vulkan_023_ObjectDynamic::createDescriptorSetLayouts: create DescriptorSetLayout: [%s] success !", nameLayout.c_str());
    }
}
VkDescriptorSetLayout Vulkan_023_ObjectDynamic::findDescriptorSetLayout(const String& nameDescriptorSetLayout)
{
...
StringVector* Vulkan_023_ObjectDynamic::findDescriptorSetLayoutNames(const String& nameDescriptorSetLayout)
{
...
void Vulkan_023_ObjectDynamic::destroyShaderModules()
{   
...
void Vulkan_023_ObjectDynamic::createShaderModules()
{
    for (int i = 0; i < g_ShaderCount; i++)
    {
        ...
        F_LogInfo("Vulkan_023_ObjectDynamic::createShaderModules: create shader, name: [%s], type: [%s], path: [%s] success !", 
                  shaderName.c_str(), shaderType.c_str(), shaderPath.c_str());
    }
}
VkShaderModule Vulkan_023_ObjectDynamic::findShaderModule(const String& nameShaderModule)
{
...
void Vulkan_023_ObjectDynamic::destroyPipelineLayouts()
{
...
void Vulkan_023_ObjectDynamic::createPipelineLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayoutCount; i++)
    {
        ...
        if (vkDescriptorSetLayout == VK_NULL_HANDLE)
        {
            F_LogError("*********************** Vulkan_023_ObjectDynamic::createPipelineLayouts: Can not find DescriptorSetLayout by name: [%s]", nameDescriptorSetLayout.c_str());
            return;
        }
        ...
        {
            F_LogError("*********************** Vulkan_023_ObjectDynamic::createPipelineLayouts: createVkPipelineLayout failed !");
            return;
        }
...
VkPipelineLayout Vulkan_023_ObjectDynamic::findPipelineLayout(const String& namePipelineLayout)
{
...
void Vulkan_023_ObjectDynamic::createDescriptorSets_Custom()
{
    //1> Object Rend
...
void Vulkan_023_ObjectDynamic::createDescriptorSets_Graphics(VkDescriptorSetVector& poDescriptorSets, 
                                                             ...
                                                             ModelObjectRendIndirect* pRendIndirect)
{
    ...
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_023_ObjectDynamic::createDescriptorSets_Graphics")
    ...
    {   
        ...
        for (size_t p = 0; p < count_names; p++)
        {
            ...
            {
                String msg = "*********************** Vulkan_023_ObjectDynamic::createDescriptorSets_Graphics: Graphics: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
...
void Vulkan_023_ObjectDynamic::createDescriptorSets_Compute(VKPipelineCompute* pPipelineCompute, 
                                                  ModelObjectRend* pRend)
{
    StringVector* pDescriptorSetLayoutNames = pPipelineCompute->poDescriptorSetLayoutNames;
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_023_ObjectDynamic::createDescriptorSets_Compute")
    ...
    for (size_t p = 0; p < count_names; p++)
    {
        ...
        {
            String msg = "*********************** Vulkan_023_ObjectDynamic::createDescriptorSets_Compute: Compute: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
    }  
...
void Vulkan_023_ObjectDynamic::updateCompute_BeforeRender_Custom(VkCommandBuffer& commandBuffer)
{
    size_t count_object_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_object_rend; i++)
    {
...
void Vulkan_023_ObjectDynamic::updateCBs_Custom()
{
    //1> Object Rend
...
void Vulkan_023_ObjectDynamic::updateRenderPass_SyncComputeGraphics(VkCommandBuffer& commandBuffer)
{
    size_t count_object_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_object_rend; i++)
    {
...
bool Vulkan_023_ObjectDynamic::beginRenderImgui()
{
    ImGui_ImplVulkan_NewFrame();
    ImGui_ImplGlfw_NewFrame();
    ImGui::NewFrame();
    static bool windowOpened = true;
    ImGui::Begin("Vulkan_023_ObjectDynamic", &windowOpened, 0);
    {
        //0> Common
        commonConfig();
...
void Vulkan_023_ObjectDynamic::modelConfig()
{
...
void Vulkan_023_ObjectDynamic::endRenderImgui()
{
    VulkanWindow::endRenderImgui();

}

void Vulkan_023_ObjectDynamic::drawMeshDefault_Custom(VkCommandBuffer& commandBuffer)
{   
...
void Vulkan_023_ObjectDynamic::drawModelObjectRendIndirects(VkCommandBuffer& commandBuffer, ModelObjectRendPtrVector& aRends)
{
...
void Vulkan_023_ObjectDynamic::drawModelObjectRendIndirect(VkCommandBuffer& commandBuffer, ModelObjectRendIndirect* pRendIndirect)
{
...
void Vulkan_023_ObjectDynamic::drawModelObjectRends(VkCommandBuffer& commandBuffer, ModelObjectRendPtrVector& aRends)
{
    size_t count_rend = aRends.size();
    for (size_t i = 0; i < count_rend; i++)
    {
...
void Vulkan_023_ObjectDynamic::drawModelObjectRend(VkCommandBuffer& commandBuffer, ModelObjectRend* pRend)
{
    ModelObject* pModelObject = pRend->pModelObject;
...
void Vulkan_023_ObjectDynamic::cleanupSwapChain_Custom()
{
    size_t count = this->m_aModelObjects.size();
    for (size_t i = 0; i < count; i++)
    {
...
void Vulkan_023_ObjectDynamic::recreateSwapChain_Custom()
{   
    size_t count = this->m_aModelObjects.size();
    for (size_t i = 0; i < count; i++)
    {
