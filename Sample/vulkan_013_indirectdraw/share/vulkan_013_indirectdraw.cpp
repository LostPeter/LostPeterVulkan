...
bool Vulkan_013_IndirectDraw::ModelMeshSub::CreateMeshSub(FMeshData& meshData, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
...
void Vulkan_013_IndirectDraw::ModelMeshSub::WriteVertexData(std::vector<FVertex_Pos3Color4Normal3Tex2>& aPos3Color4Normal3Tex2,
...
bool Vulkan_013_IndirectDraw::ModelMesh::LoadMesh(bool isFlipY, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    //1> Load
    ...
    else if (this->typeMesh == F_Mesh_Geometry)
    {
        ...
        {
            F_LogError("Vulkan_013_IndirectDraw::ModelMesh::LoadMesh: create geometry mesh failed: typeGeometry: [%s] !", F_GetMeshGeometryTypeName(this->typeGeometryType).c_str());
            return false; 
        }
    ...
    {
        F_Assert(false && "Vulkan_013_IndirectDraw::ModelMesh::LoadMesh: Wrong typeMesh !")
        return false;
    }
...
bool Vulkan_013_IndirectDraw::createPipelineShaderStageCreateInfos(const String& nameShaderVert,
...
bool Vulkan_013_IndirectDraw::createPipelineShaderStageCreateInfos(const String& nameShaderComp,
                                                                   VkPipelineShaderStageCreateInfoVector& aStageCreateInfos_Compute,
                                                                   VkPipelineShaderStageCreateInfoMap& mapStageCreateInfos_Compute)
{
    //comp
