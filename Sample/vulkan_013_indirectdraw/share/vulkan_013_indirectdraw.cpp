    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        if (isCreateVkBuffer)
        {
            ...
            for (size_t j = 0; j < count_sci; j++) 
            {
				...
				if (!pBufferUniform)
				{
					String msg = "*********************** Vulkan_013_IndirectDraw::createCustomCB: create buffer uniform: [" + nameBuffer + "] failed !";
					F_LogError(msg.c_str());
					throw std::runtime_error(msg);
				}
...
StringVector* Vulkan_013_IndirectDraw::findDescriptorSetLayoutNames(const String& nameDescriptorSetLayout)
{
...
VkPipelineLayout Vulkan_013_IndirectDraw::findPipelineLayout(const String& namePipelineLayout)
{
                                                            ...
                                                            ModelObjectRendIndirect* pRendIndirect)
{
    ...
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_013_IndirectDraw::createDescriptorSets_Graphics")
...
void Vulkan_013_IndirectDraw::createDescriptorSets_Compute(VKPipelineCompute* pPipelineCompute, 
                                                           ModelObjectRend* pRend)
{
    StringVector* pDescriptorSetLayoutNames = pPipelineCompute->poDescriptorSetLayoutNames;
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_013_IndirectDraw::createDescriptorSets_Compute")
