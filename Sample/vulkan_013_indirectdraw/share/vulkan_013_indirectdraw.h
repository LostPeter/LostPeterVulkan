...
#ifndef _VULKAN_013_INDIRECTDRAW_H_
#define _VULKAN_013_INDIRECTDRAW_H_

#include "VulkanWindow.h"
#include "VulkanMath.h"
using namespace LostPeter; 

class Vulkan_013_IndirectDraw : public VulkanWindow
{
public:
    Vulkan_013_IndirectDraw(int width, int height, String name);
...
public:
    ...
    struct ModelTexture
    {
        ...
        ModelTexture(Vulkan_013_IndirectDraw* _pWindow, 
    ...
    struct PipelineGraphics
    {
        ...
        PipelineGraphics(Vulkan_013_IndirectDraw* _pWindow)
            : pWindow(_pWindow)
    ...
    struct PipelineCompute
    {
        ...
        PipelineCompute(Vulkan_013_IndirectDraw* _pWindow)
            : pWindow(_pWindow)
            , nameDescriptorSetLayout("")
            , poDescriptorSetLayoutNames(nullptr)
            , poDescriptorSetLayout(VK_NULL_HANDLE)
