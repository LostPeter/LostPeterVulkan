...
#ifndef _VULKAN_019_TERRAIN_H_
#define _VULKAN_019_TERRAIN_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeter; 

class Vulkan_019_Terrain : public VulkanWindow
{
public:
    Vulkan_019_Terrain(int width, int height, String name);
...
public:
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_019_Terrain* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
