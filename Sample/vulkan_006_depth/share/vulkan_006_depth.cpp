...
void Vulkan_006_Depth::createGraphicsPipeline_Custom()
{
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        pModelObject->poPipelineGraphics = createVkGraphicsPipeline(vertShaderModule, "main",
                                                                    ...
                                                                    pModelObject->cfg_vkPrimitiveTopology, pModelObject->cfg_vkFrontFace, pModelObject->cfg_vkPolygonMode, pModelObject->cfg_vkCullModeFlagBits, this->cfg_LineWidth,
