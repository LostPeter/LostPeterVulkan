...
{   
    ...
    FVector3(   0,  0.0,   0.0),    FVector3(     0,  0,  0),    FVector3(    1.0f,      1.0f,      1.0f), //copy_frame-1
};
...
bool Vulkan_014_MultiRenderPass::ModelMeshSub::CreateMeshSub(FMeshData& meshData, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    ...
    {   
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Tex2]: Vertex count: [%d], Index count: [%d] !", 
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tex2)
    {
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tex2]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tex4)
    {
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tex4]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tangent3Tex2)
    {
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tangent3Tex2]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tangent3Tex4)
    {
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tangent3Tex4]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    {
        F_LogError("Vulkan_014_MultiRenderPass::ModelMeshSub::CreateMeshSub: create mesh sub failed: [%s], wrong poTypeVertex !", this->nameMeshSub.c_str());
        return false; 
    }
...
bool Vulkan_014_MultiRenderPass::ModelMesh::AddMeshSub(ModelMeshSub* pMeshSub)
{
    ...
    {
        F_LogError("Vulkan_014_MultiRenderPass::ModelMesh::AddMeshSub: Mesh sub is exist: [%s] !", pMeshSub->nameMeshSub.c_str());
        return false;
    }
...
bool Vulkan_014_MultiRenderPass::ModelMesh::LoadMesh(bool isFlipY, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    ...
    {
        F_Assert(false && "Vulkan_014_MultiRenderPass::ModelMesh::LoadMesh: Wrong typeMesh !")
        return false;
    }
    ...
    for (int i = 0; i < count_mesh_sub; i++)
    {
        ...
        {
            F_LogError("Vulkan_014_MultiRenderPass::ModelMesh::LoadMesh: Create mesh sub failed: [%s] !", nameMeshSub.c_str());
            return false;
        }
        AddMeshSub(pMeshSub);
    }
    ...
    else
    {
        ...
        //3> Framebuffer
        {
            ...
            if (!this->pWindow->createVkFramebuffer(this->nameRenderPass,
                                                    ...
                                                    this->poFrameBuffer))
            {
                String msg = "Vulkan_014_MultiRenderPass::MultiRenderPass::Init: Failed to create framebuffer: " + this->nameRenderPass;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg);
            }
        }
...
{
    F_Assert(_aRends.size() > 0 && "Vulkan_014_MultiRenderPass::ModelObjectRendIndirect::SetupVertexIndexBuffer")
    this->aRends.clear();
    this->aRends = _aRends;
    ...
    {
        F_Assert(false && "Vulkan_014_MultiRenderPass::ModelObjectRendIndirect::SetupVertexIndexBuffer: No vertex data !")
    }
...
Vulkan_014_MultiRenderPass::Vulkan_014_MultiRenderPass(int width, int height, String name)
...
void Vulkan_014_MultiRenderPass::setUpEnabledFeatures()
{
    ...
    else
    {
        ...
        F_LogError("Vulkan_014_MultiRenderPass::setUpEnabledFeatures: multiDrawIndirect is not supported !");
    }
}
    ...
    for (int i = 0; i < g_Object_Count; i++)
    {
        ...
        //1> Object
        {
            ...
            //Mesh
            {
                ...
                F_Assert(pMesh != nullptr && "Vulkan_014_MultiRenderPass::loadModel_Custom")
        ...
        //2> ObjectRend
        {
            ...
            for (size_t j = 0; j < count_mesh_sub_used; j++)
            {
                ...
                F_Assert(indexMeshSub >= 0 && indexMeshSub < count_mesh_sub && "Vulkan_014_MultiRenderPass::loadModel_Custom")
...
void Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom()
{
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            String msg = "Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Can not find shader used !";
            F_LogError(msg.c_str());
        ...
        //[2] Pipeline Graphics
        {
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Can not find DescriptorSetLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Can not find PipelineLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Failed to create pipeline graphics wire frame: " + pRend->nameObjectRend;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            F_LogInfo("Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics wire frame success !", pRend->nameObjectRend.c_str());
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Failed to create pipeline graphics: " + pRend->nameObjectRend;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            F_LogInfo("Vulkan_014_MultiRenderPass::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics graphics success !", pRend->nameObjectRend.c_str());
        }
    }
}
void Vulkan_014_MultiRenderPass::createComputePipeline_Custom()
{
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            String msg = "Vulkan_014_MultiRenderPass::createComputePipeline_Custom: Can not find shader used !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            String msg = "Vulkan_014_MultiRenderPass::createComputePipeline_Custom: Pipeline count is not equal shader count !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        for (size_t j = 0; j < count_pipeline; j ++)
        {
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createComputePipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createComputePipeline_Custom: Can not find DescriptorSetLayout by name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createComputePipeline_Custom: Can not find PipelineLayout by name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createComputePipeline_Custom: Create compute pipeline failed, PipelineLayout name: " + p->nameDescriptorSetLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
...
void Vulkan_014_MultiRenderPass::createModelMeshes()
{
    for (int i = 0; i < g_Mesh_Count; i++)
    {
        ...
        {
            String msg = "Vulkan_014_MultiRenderPass::createModelMeshes: create mesh: [" + nameMesh + "] failed !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg);
        }
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::createModelMeshes: create mesh: [%s], vertex type: [%s], mesh type: [%s], geometry type: [%s], mesh sub count: [%d], path: [%s] success !", 
                  nameMesh.c_str(), nameVertexType.c_str(), nameMeshType.c_str(), nameGeometryType.c_str(), (int)pMesh->aMeshSubs.size(), pathMesh.c_str());
    }
}
Vulkan_014_MultiRenderPass::ModelMesh* Vulkan_014_MultiRenderPass::findModelMesh(const String& nameMesh)
{
...
void Vulkan_014_MultiRenderPass::createModelTextures()
{
    for (int i = 0; i < g_Texture_Count; i++)
    {
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::createModelTextures: create texture: [%s], type: [%s], isRT: [%s], path: [%s] success !", 
                  nameTexture.c_str(), 
                  nameType.c_str(), 
...
Vulkan_014_MultiRenderPass::ModelTexture* Vulkan_014_MultiRenderPass::findModelTexture(const String& nameTexture)
{
...
void Vulkan_014_MultiRenderPass::createDescriptorSetLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayout_Count; i++)
    {
        ...
        for (size_t j = 0; j < count_layout; j++)
        {
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createDescriptorSetLayouts: Wrong DescriptorSetLayout type: " + strLayout;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::createDescriptorSetLayouts: create DescriptorSetLayout: [%s] success !", nameLayout.c_str());
    }
}
VkDescriptorSetLayout Vulkan_014_MultiRenderPass::findDescriptorSetLayout(const String& nameDescriptorSetLayout)
{
...
StringVector* Vulkan_014_MultiRenderPass::findDescriptorSetLayoutNames(const String& nameDescriptorSetLayout)
{
...
void Vulkan_014_MultiRenderPass::createShaderModules()
{
    for (int i = 0; i < g_Shader_Count; i++)
    {
        ...
        F_LogInfo("Vulkan_014_MultiRenderPass::createShaderModules: create shader, name: [%s], type: [%s], path: [%s] success !", 
                  shaderName.c_str(), shaderType.c_str(), shaderPath.c_str());
    }
}
VkShaderModule Vulkan_014_MultiRenderPass::findShaderModule(const String& nameShaderModule)
{
...
bool Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos(const String& nameShaderVert,
                                                                      ...
                                                                      VkPipelineShaderStageCreateInfoVector& aStageCreateInfos_Graphics)
{
    //vert
    {
        ...
        {
            F_LogError("Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos: Can not find vert shader module: [%s] !", nameShaderVert.c_str());
            return false;
        }
    ...
    if (!nameShaderTesc.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos: Can not find tesc shader module: [%s] !", nameShaderTesc.c_str());
            return false;
        }
    ...
    if (!nameShaderTese.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos: Can not find tese shader module: [%s] !", nameShaderTese.c_str());
            return false;
        }
    ...
    if (!nameShaderGeom.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos: Can not find geom shader module: [%s] !", nameShaderGeom.c_str());
            return false;
        }
    ...
    //frag
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos: Can not find frag shader module: [%s] !", nameShaderFrag.c_str());
            return false;
        }
...
bool Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos(const String& nameShaderComp,
                                                                      VkPipelineShaderStageCreateInfoVector& aStageCreateInfos_Compute,
                                                                      VkPipelineShaderStageCreateInfoMap& mapStageCreateInfos_Compute)
{
    //comp
    if (!nameShaderComp.empty())
    {
        ...
        for (int i = 0; i < count_comp; i++)
        {
            ...
            if (shaderModule == VK_NULL_HANDLE)
            {
                F_LogError("Vulkan_014_MultiRenderPass::createPipelineShaderStageCreateInfos: Can not find comp shader module: [%s] !", nameSC.c_str());
                return false;
            }
...
void Vulkan_014_MultiRenderPass::createPipelineLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayout_Count; i++)
    {
        ...
        {
            F_LogError("*********************** Vulkan_014_MultiRenderPass::createPipelineLayouts: Can not find DescriptorSetLayout by name: [%s]", nameDescriptorSetLayout.c_str());
            return;
        }
        ...
        {
            F_LogError("*********************** Vulkan_014_MultiRenderPass::createPipelineLayouts: createVkPipelineLayout failed !");
            return;
        }
...
VkPipelineLayout Vulkan_014_MultiRenderPass::findPipelineLayout(const String& namePipelineLayout)
{
...
Vulkan_014_MultiRenderPass::MultiRenderPass* Vulkan_014_MultiRenderPass::findMultiRenderPass(const String& nameRenderPass)
{
                                                               ...
                                                               ModelObjectRendIndirect* pRendIndirect)
{
    ...
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_014_MultiRenderPass::createDescriptorSets_Graphics")
    ...
    {   
        ...
        for (size_t p = 0; p < count_names; p++)
        {
            ...
            {
                String msg = "Vulkan_014_MultiRenderPass::createDescriptorSets_Graphics: Graphics: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
                                                              ...
                                                              ModelObjectRend* pRend)
{
    ...
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_014_MultiRenderPass::createDescriptorSets_Compute")
    ...
    for (size_t p = 0; p < count_names; p++)
    {
        ...
        {
            String msg = "Vulkan_014_MultiRenderPass::createDescriptorSets_Compute: Compute: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
    }  
