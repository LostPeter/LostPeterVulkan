...
#ifndef _VULKAN_020_CULLING_H_
#define _VULKAN_020_CULLING_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeterVulkan; 

class Vulkan_020_Culling : public VulkanWindow
{
public:
...
public: 
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_020_Culling* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
