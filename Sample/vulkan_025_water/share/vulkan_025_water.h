...
class Vulkan_023_Water : public VulkanWindow
{
public:
    Vulkan_023_Water(int width, int height, String name);
...
public:
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_023_Water* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
