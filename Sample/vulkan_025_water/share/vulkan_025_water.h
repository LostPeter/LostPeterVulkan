...
#ifndef _VULKAN_025_WATER_H_
#define _VULKAN_025_WATER_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeterVulkan; 

class Vulkan_025_Water : public VulkanWindow
{
public:
    Vulkan_025_Water(int width, int height, String name);
...
public:
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_025_Water* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
