...
/////////////////////////// ModelMeshSub ////////////////////////
void Vulkan_014_Terrain::ModelMeshSub::Destroy()
{
    //Vertex
...
bool Vulkan_014_Terrain::ModelMeshSub::CreateMeshSub(MeshData& meshData, bool isTranformLocal, const glm::mat4& matTransformLocal)
{
    ...
    {
        Util_LogError("Vulkan_014_Terrain::ModelMeshSub::CreateMeshSub: create mesh sub failed: [%s], wrong poTypeVertex !", this->nameMeshSub.c_str());
        return false; 
    }
...
/////////////////////////// ModelMesh ///////////////////////////
bool Vulkan_014_Terrain::ModelMesh::AddMeshSub(ModelMeshSub* pMeshSub)
{
    ModelMeshSubPtrMap::iterator itFind = this->mapMeshSubs.find(pMeshSub->nameMeshSub);
    if (itFind != this->mapMeshSubs.end())
    {
        Util_LogError("Vulkan_014_Terrain::ModelMesh::AddMeshSub: Mesh sub is exist: [%s] !", pMeshSub->nameMeshSub.c_str());
        return false;
    }
...
bool Vulkan_014_Terrain::ModelMesh::LoadMesh(bool isFlipY, bool isTranformLocal, const glm::mat4& matTransformLocal)
{
    //1> Load
    ...
    if (this->typeMesh == Vulkan_Mesh_File)
    {
        ...
        {
            Util_LogError("Vulkan_014_Terrain::ModelMesh::LoadMesh: load meshes failed: [%s] !", this->pathMesh.c_str());
            return false; 
        }
    }
    else if (this->typeMesh == Vulkan_Mesh_Geometry)
    {
        ...
        {
            Util_LogError("Vulkan_014_Terrain::ModelMesh::LoadMesh: create geometry mesh failed: typeGeometry: [%s] !", Util_GetMeshGeometryTypeName(this->typeGeometryType).c_str());
            return false; 
        }
    ...
    {
        assert(false && "Vulkan_014_Terrain::ModelMesh::LoadMesh: Wrong typeMesh !");
        return false;
    }
    ...
    for (int i = 0; i < count_mesh_sub; i++)
    {
        ...
        {
            Util_LogError("Vulkan_014_Terrain::ModelMesh::LoadMesh: Create mesh sub failed: [%s] !", nameMeshSub.c_str());
            return false;
        }
        AddMeshSub(pMeshSub);
    }
...
/////////////////////////// ModelTexture ////////////////////////
void Vulkan_014_Terrain::ModelTexture::UpdateTexture()
{
...
void Vulkan_014_Terrain::ModelTexture::updateNoiseTextureData()
{
    // Perlin noise
...
void Vulkan_014_Terrain::ModelTexture::updateNoiseTexture()
{
...
Vulkan_014_Terrain::Vulkan_014_Terrain(int width, int height, std::string name)
...
void Vulkan_014_Terrain::setUpEnabledFeatures()
{
    ...
    {
        Util_LogError("Vulkan_014_Terrain::setUpEnabledFeatures: tessellationShader is not supported !");
    }

}

void Vulkan_014_Terrain::createDescriptorSetLayout_Custom()
{
    VulkanWindow::createDescriptorSetLayout_Custom();
}

void Vulkan_014_Terrain::createCamera()
{
    ...
    for (int i = 0; i < g_Object_Count; i++)
    {
        ...
        //Object
        {
            ...
            //Mesh
            {
                ...
                assert(pMesh != nullptr && "Vulkan_014_Terrain::loadModel_Custom");
...
void Vulkan_014_Terrain::createCustomCB()
{
    rebuildInstanceCBs(true);
}
void Vulkan_014_Terrain::rebuildInstanceCBs(bool isCreateVkBuffer)
{   
...
void Vulkan_014_Terrain::createCustomBeforePipeline()
{
...
void Vulkan_014_Terrain::createGraphicsPipeline_Custom()
{
    //1> Viewport
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            std::string msg = "Vulkan_014_Terrain::createGraphicsPipeline_Custom: Can not find shader used !";
        ...
        //[2] Pipeline Graphics
        {
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createGraphicsPipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createGraphicsPipeline_Custom: Can not find DescriptorSetLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createGraphicsPipeline_Custom: Can not find PipelineLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createGraphicsPipeline_Custom: Failed to create pipeline graphics wire frame: " + pRend->nameObjectRend;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            Util_LogInfo("Vulkan_014_Terrain::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics wire frame success !", pRend->nameObjectRend.c_str());
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createGraphicsPipeline_Custom: Failed to create pipeline graphics: " + pRend->nameObjectRend;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            Util_LogInfo("Vulkan_014_Terrain::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics graphics success !", pRend->nameObjectRend.c_str());
        }
    }
}
void Vulkan_014_Terrain::createComputePipeline_Custom()
{
    size_t count_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            std::string msg = "Vulkan_014_Terrain::createComputePipeline_Custom: Can not find shader used !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            std::string msg = "Vulkan_014_Terrain::createComputePipeline_Custom: Pipeline count is not equal shader count !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        for (size_t j = 0; j < count_pipeline; j ++)
        {
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createComputePipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createComputePipeline_Custom: Can not find DescriptorSetLayout by name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createComputePipeline_Custom: Can not find PipelineLayout by name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createComputePipeline_Custom: Create compute pipeline failed, PipelineLayout name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
...
void Vulkan_014_Terrain::destroyModelMeshes()
{
...
void Vulkan_014_Terrain::createModelMeshes()
{
    for (int i = 0; i < g_MeshCount; i++)
    {
        ...
        {
            std::string msg = "Vulkan_014_Terrain::createModelMeshes: create mesh: [" + nameMesh + "] failed !";
            Util_LogError(msg.c_str());
        ...
        Util_LogInfo("Vulkan_014_Terrain::createModelMeshes: create mesh: [%s], vertex type: [%s], mesh type: [%s], geometry type: [%s], path: [%s] success !", 
                     nameMesh.c_str(), nameVertexType.c_str(), nameMeshType.c_str(), nameGeometryType.c_str(), pathMesh.c_str());
    }
}
Vulkan_014_Terrain::ModelMesh* Vulkan_014_Terrain::findModelMesh(const std::string& nameMesh)
{
...
void Vulkan_014_Terrain::destroyModelTextures()
{
...
void Vulkan_014_Terrain::createModelTextures()
{
    for (int i = 0; i < g_TextureCount; i++)
    {
        ...
        Util_LogInfo("Vulkan_014_Terrain::createModelTextures: create texture: [%s], type: [%s], isRT: [%s], path: [%s] success !", 
                     nameTexture.c_str(), 
                     nameType.c_str(), 
...
Vulkan_014_Terrain::ModelTexture* Vulkan_014_Terrain::findModelTexture(const std::string& nameTexture)
{
...
void Vulkan_014_Terrain::destroyDescriptorSetLayouts()
{
...
void Vulkan_014_Terrain::createDescriptorSetLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayoutCount; i++)
    {
        ...
        for (size_t j = 0; j < count_layout; j++)
        {
            ...
            {
                std::string msg = "Vulkan_014_Terrain::createDescriptorSetLayouts: Wrong DescriptorSetLayout type: " + strLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
        ...
        Util_LogInfo("Vulkan_014_Terrain::createDescriptorSetLayouts: create DescriptorSetLayout: [%s] success !", nameLayout.c_str());
    }
}
VkDescriptorSetLayout Vulkan_014_Terrain::findDescriptorSetLayout(const std::string& nameDescriptorSetLayout)
{
...
std::vector<std::string>* Vulkan_014_Terrain::findDescriptorSetLayoutNames(const std::string& nameDescriptorSetLayout)
{
...
void Vulkan_014_Terrain::destroyShaderModules()
{   
...
void Vulkan_014_Terrain::createShaderModules()
{
    for (int i = 0; i < g_ShaderCount; i++)
    {
        ...
        Util_LogInfo("Vulkan_014_Terrain::createShaderModules: create shader, name: [%s], type: [%s], path: [%s] success !", 
                     shaderName.c_str(), shaderType.c_str(), shaderPath.c_str());
    }
}
VkShaderModule Vulkan_014_Terrain::findShaderModule(const std::string& nameShaderModule)
{
...
bool Vulkan_014_Terrain::createPipelineShaderStageCreateInfos(const std::string& nameShaderVert,
                                                                   ...
                                                                   VkPipelineShaderStageCreateInfoVector& aStageCreateInfos_Graphics)
{
    //vert
    {
        ...
        {
            Util_LogError("Vulkan_014_Terrain::createPipelineShaderStageCreateInfos: Can not find vert shader module: [%s] !", nameShaderVert.c_str());
            return false;
        }
    ...
    if (!nameShaderTesc.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            Util_LogError("Vulkan_014_Terrain::createPipelineShaderStageCreateInfos: Can not find tesc shader module: [%s] !", nameShaderTesc.c_str());
            return false;
        }
    ...
    if (!nameShaderTese.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            Util_LogError("Vulkan_014_Terrain::createPipelineShaderStageCreateInfos: Can not find tese shader module: [%s] !", nameShaderTese.c_str());
            return false;
        }
    ...
    if (!nameShaderGeom.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            Util_LogError("Vulkan_014_Terrain::createPipelineShaderStageCreateInfos: Can not find geom shader module: [%s] !", nameShaderGeom.c_str());
            return false;
        }
    ...
    //frag
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            Util_LogError("Vulkan_014_Terrain::createPipelineShaderStageCreateInfos: Can not find frag shader module: [%s] !", nameShaderFrag.c_str());
            return false;
        }
...
bool Vulkan_014_Terrain::createPipelineShaderStageCreateInfos(const std::string& nameShaderComp,
                                                                VkPipelineShaderStageCreateInfoVector& aStageCreateInfos_Compute,
                                                                VkPipelineShaderStageCreateInfoMap& mapStageCreateInfos_Compute)
{
    //comp
    if (!nameShaderComp.empty())
    {
        ...
        for (int i = 0; i < count_comp; i++)
        {
            ...
            if (shaderModule == VK_NULL_HANDLE)
            {
                Util_LogError("Vulkan_014_Terrain::createPipelineShaderStageCreateInfos: Can not find comp shader module: [%s] !", nameSC.c_str());
                return false;
            }
...
void Vulkan_014_Terrain::destroyPipelineLayouts()
{
...
void Vulkan_014_Terrain::createPipelineLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayoutCount; i++)
    {
        ...
        {
            Util_LogError("*********************** Vulkan_014_Terrain::createPipelineLayouts: Can not find DescriptorSetLayout by name: [%s]", nameDescriptorSetLayout.c_str());
            return;
        }
        ...
        {
            Util_LogError("*********************** Vulkan_014_Terrain::createPipelineLayouts: createVkPipelineLayout failed !");
            return;
        }
...
VkPipelineLayout Vulkan_014_Terrain::findPipelineLayout(const std::string& namePipelineLayout)
{
...
void Vulkan_014_Terrain::createDescriptorSets_Custom()
{
    size_t count_sci = this->poSwapChainImages.size();
    ...
    for (size_t i = 0; i < count_object_rend; i++)
    {
        ...
        //Pipeline Graphics
        {
            ...
            assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_014_Terrain::createDescriptorSets_Custom");
            ...
            {   
                ...
                for (size_t p = 0; p < count_names; p++)
                {
                    ...
                    {
                        std::string msg = "Vulkan_014_Terrain::createDescriptorSets_Custom: Graphics: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
                        Util_LogError(msg.c_str());
                        throw std::runtime_error(msg.c_str());
                    }
                }
        ...
        {       
            ...
            for (size_t p = 0; p < count_names; p++)
            {
                ...
                {
                    std::string msg = "Vulkan_014_Terrain::createDescriptorSets_Custom: Compute: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
                    Util_LogError(msg.c_str());
                    throw std::runtime_error(msg.c_str());
                }
            }  
...
void Vulkan_014_Terrain::updateCompute_Custom(VkCommandBuffer& commandBuffer)
{
    size_t count_object_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_object_rend; i++)
    {
...
void Vulkan_014_Terrain::updateCBs_Custom()
{
...
void Vulkan_014_Terrain::updateRenderPass_SyncComputeGraphics(VkCommandBuffer& commandBuffer)
{
    size_t count_object_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_object_rend; i++)
    {
...
bool Vulkan_014_Terrain::beginRenderImgui()
{
    ImGui_ImplVulkan_NewFrame();
    ImGui_ImplGlfw_NewFrame();
    ImGui::NewFrame();
    static bool windowOpened = true;
    ImGui::Begin("Vulkan_014_Terrain", &windowOpened, 0);
    {
        //0> Common
        commonConfig();
...
void Vulkan_014_Terrain::modelConfig()
{
...
void Vulkan_014_Terrain::endRenderImgui()
{
    VulkanWindow::endRenderImgui();

}

void Vulkan_014_Terrain::drawMesh_Custom(VkCommandBuffer& commandBuffer)
{   
    //1> Opaque
    {
...
void Vulkan_014_Terrain::drawModelObjectRends(VkCommandBuffer& commandBuffer, ModelObjectRendPtrVector& aRends)
{
...
void Vulkan_014_Terrain::drawModelObjectRend(VkCommandBuffer& commandBuffer, ModelObjectRend* pRend)
{
...
void Vulkan_014_Terrain::cleanupCustom()
{   
...
void Vulkan_014_Terrain::cleanupSwapChain_Custom()
{
    size_t count = this->m_aModelObjects.size();
    for (size_t i = 0; i < count; i++)
    {
...
void Vulkan_014_Terrain::recreateSwapChain_Custom()
{   
    size_t count = this->m_aModelObjects.size();
    for (size_t i = 0; i < count; i++)
    {
