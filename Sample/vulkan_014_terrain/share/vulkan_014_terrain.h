...
#ifndef _VULKAN_014_TERRAIN_H_
#define _VULKAN_014_TERRAIN_H_

#include "VulkanWindow.h"
#include "VulkanMath.h"
using namespace LostPeter; 

class Vulkan_014_Terrain : public VulkanWindow
{
public:
    Vulkan_014_Terrain(int width, int height, std::string name);
...
public:
    ...
    struct ModelMesh
    {
        ...
        ModelMesh(Vulkan_014_Terrain* _pWindow, 
    ...
    struct ModelTexture
    {
        ...
        ModelTexture(Vulkan_014_Terrain* _pWindow, 
    ...
    struct PipelineGraphics
    {
        ...
        PipelineGraphics(Vulkan_014_Terrain* _pWindow)
            : pWindow(_pWindow)
    ...
    struct PipelineCompute
    {
        ...
        PipelineCompute(Vulkan_014_Terrain* _pWindow)
            : pWindow(_pWindow)
            , nameDescriptorSetLayout("")
            , poDescriptorSetLayoutNames(nullptr)
            , poDescriptorSetLayout(VK_NULL_HANDLE)
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_014_Terrain* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
