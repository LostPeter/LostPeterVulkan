...
bool Vulkan_017_Terrain::ModelMeshSub::CreateMeshSub(FMeshData& meshData, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    ...
    if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tex2)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tex2]: Vertex count: [%d], Index count: [%d] !", 
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tex4)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tex4]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tangent3Tex2)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tangent3Tex2]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tangent3Tex4)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tangent3Tex4]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    {
        F_LogError("Vulkan_017_Terrain::ModelMeshSub::CreateMeshSub: create mesh sub failed: [%s], wrong poTypeVertex !", this->nameMeshSub.c_str());
        return false; 
    }
...
void Vulkan_017_Terrain::ModelMeshSub::WriteVertexData(std::vector<FVertex_Pos3Color4Normal3Tex2>& aPos3Color4Normal3Tex2,
...
bool Vulkan_017_Terrain::ModelMesh::AddMeshSub(ModelMeshSub* pMeshSub)
{
    ...
    {
        F_LogError("Vulkan_017_Terrain::ModelMesh::AddMeshSub: Mesh sub is exist: [%s] !", pMeshSub->nameMeshSub.c_str());
        return false;
    }
...
bool Vulkan_017_Terrain::ModelMesh::LoadMesh(bool isFlipY, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    ...
    if (this->typeMesh == F_Mesh_File)
    {
        ...
        {
            F_LogError("Vulkan_017_Terrain::ModelMesh::LoadMesh: load meshes failed: [%s] !", this->pathMesh.c_str());
            return false; 
        }
    }
    else if (this->typeMesh == F_Mesh_Geometry)
    {
        ...
        {
            F_LogError("Vulkan_017_Terrain::ModelMesh::LoadMesh: create geometry mesh failed: typeGeometry: [%s] !", F_GetMeshGeometryTypeName(this->typeGeometryType).c_str());
            return false; 
        }
    ...
    {
        F_Assert(false && "Vulkan_017_Terrain::ModelMesh::LoadMesh: Wrong typeMesh !")
        return false;
    }
    ...
    for (int i = 0; i < count_mesh_sub; i++)
    {
        ...
        {
            F_LogError("Vulkan_017_Terrain::ModelMesh::LoadMesh: Create mesh sub failed: [%s] !", nameMeshSub.c_str());
            return false;
        }
        AddMeshSub(pMeshSub);
    }
...
{
    F_Assert(_aRends.size() > 0 && "Vulkan_017_Terrain::ModelObjectRendIndirect::SetupVertexIndexBuffer")
    this->aRends.clear();
    this->aRends = _aRends;
    ...
    {
        F_Assert(false && "Vulkan_017_Terrain::ModelObjectRendIndirect::SetupVertexIndexBuffer: No vertex data !")
    }
...
void Vulkan_017_Terrain::setUpEnabledFeatures()
{
    ...
    else
    {
        ...
        F_LogError("Vulkan_017_Terrain::setUpEnabledFeatures: multiDrawIndirect is not supported !");
    }
}
    ...
    for (int i = 0; i < g_Object_Count; i++)
    {
        ...
        //1> Object
        {
            ...
            //Mesh
            {
                ...
                F_Assert(pMesh != nullptr && "Vulkan_017_Terrain::loadModel_Custom")
        ...
        //2> ObjectRend
        {
            ...
            for (size_t j = 0; j < count_mesh_sub_used; j++)
            {
                ...
                F_Assert(indexMeshSub >= 0 && indexMeshSub < count_mesh_sub && "Vulkan_017_Terrain::loadModel_Custom")
...
void Vulkan_017_Terrain::createGraphicsPipeline_Custom()
{
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        //[2] Pipeline Graphics
        {
            ...
            F_LogInfo("Vulkan_017_Terrain::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics wire frame success !", pRend->nameObjectRend.c_str());
            ...
            F_LogInfo("Vulkan_017_Terrain::createGraphicsPipeline_Custom: Object: [%s] Create pipeline graphics graphics success !", pRend->nameObjectRend.c_str());
        }
    }
}
...
void Vulkan_017_Terrain::createModelMeshes()
{
    for (int i = 0; i < g_MeshCount; i++)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::createModelMeshes: create mesh: [%s], vertex type: [%s], mesh type: [%s], geometry type: [%s], mesh sub count: [%d], path: [%s] success !", 
...
void Vulkan_017_Terrain::createModelTextures()
{
    for (int i = 0; i < g_TextureCount; i++)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::createModelTextures: create texture: [%s], type: [%s], isRT: [%s], path: [%s] success !", 
                  nameTexture.c_str(), 
                  nameType.c_str(), 
...
void Vulkan_017_Terrain::createDescriptorSetLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayoutCount; i++)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::createDescriptorSetLayouts: create DescriptorSetLayout: [%s] success !", nameLayout.c_str());
    }
}
...
void Vulkan_017_Terrain::createShaderModules()
{
    for (int i = 0; i < g_ShaderCount; i++)
    {
        ...
        F_LogInfo("Vulkan_017_Terrain::createShaderModules: create shader, name: [%s], type: [%s], path: [%s] success !", 
...
void Vulkan_017_Terrain::createPipelineLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayoutCount; i++)
    {
        ...
        {
            F_LogError("*********************** Vulkan_017_Terrain::createPipelineLayouts: Can not find DescriptorSetLayout by name: [%s]", nameDescriptorSetLayout.c_str());
            return;
        }
        ...
        {
            F_LogError("*********************** Vulkan_017_Terrain::createPipelineLayouts: createVkPipelineLayout failed !");
            return;
        }
                                                       ...
                                                       ModelObjectRendIndirect* pRendIndirect)
{
    ...
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_017_Terrain::createDescriptorSets_Graphics")
                                                           ...
                                                           ModelObjectRend* pRend)
{
    ...
    F_Assert(pDescriptorSetLayoutNames != nullptr && "Vulkan_017_Terrain::createDescriptorSets_Compute")
