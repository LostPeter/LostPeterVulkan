...
#ifndef _VULKAN_017_TERRAIN_H_
#define _VULKAN_017_TERRAIN_H_

#include "VulkanWindow.h"
#include "VulkanMath.h"
using namespace LostPeter; 

class Vulkan_017_Terrain : public VulkanWindow
{
public:
    Vulkan_017_Terrain(int width, int height, String name);
...
public:
    ...
    struct ModelMesh
    {
        ...
        ModelMesh(Vulkan_017_Terrain* _pWindow, 
    ...
    struct ModelTexture
    {
        ...
        ModelTexture(Vulkan_017_Terrain* _pWindow, 
    ...
    struct PipelineGraphics
    {
        ...
        PipelineGraphics(Vulkan_017_Terrain* _pWindow)
            : pWindow(_pWindow)
    ...
    struct PipelineCompute
    {
        ...
        PipelineCompute(Vulkan_017_Terrain* _pWindow)
            : pWindow(_pWindow)
            , nameDescriptorSetLayout("")
            , poDescriptorSetLayoutNames(nullptr)
            , poDescriptorSetLayout(VK_NULL_HANDLE)
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_017_Terrain* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
