...
Vulkan_018_Object::Mesh* Vulkan_018_Object::findMesh(const String& nameMesh)
{
...
Vulkan_018_Object::Texture* Vulkan_018_Object::findTexture(const String& nameTexture)
{
