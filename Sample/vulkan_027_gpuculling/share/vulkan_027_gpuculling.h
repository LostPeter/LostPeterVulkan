...
#ifndef _VULKAN_027_GPU_CULLING_H_
#define _VULKAN_027_GPU_CULLING_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeterVulkan; 

class Vulkan_027_GPUCulling : public VulkanWindow
{
public:
    Vulkan_027_GPUCulling(int width, int height, String name);
...
public: 
    ...
    struct ModelObjectRend
    {
		...
		VKStatePipelineGraphics* poStatePipelineGraphics_Cull;
        ...
        ModelObjectRend(const String& _nameObjectRend,
			...
			, poStatePipelineGraphics_Cull(nullptr)
        ...
        void CleanupSwapChain()
        {
			...
			F_DELETE(this->poStatePipelineGraphics_Cull)
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_027_GPUCulling* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
