...
/////////////////////////// ModelObjectRend /////////////////////
void Vulkan_027_GPUCulling::ModelObjectRend::AddLine3D_AABB()
{
...
void Vulkan_027_GPUCulling::ModelObjectRend::RemoveLine3D_AABB()
{
    bool isNeedUpdateBuffer = false;
    int count_instance = this->pModelObject->countInstance;
    for (int i = 0; i < count_instance; i++)
...
void Vulkan_027_GPUCulling::ModelObjectRend::AddLine3D_Sphere()
{
    bool isNeedUpdateBuffer = false;
    int count_instance = this->pModelObject->countInstance;
    for (int i = 0; i < count_instance; i++)
...
void Vulkan_027_GPUCulling::ModelObjectRend::RemoveLine3D_Sphere()
{
    bool isNeedUpdateBuffer = false;
    int count_instance = this->pModelObject->countInstance;
    for (int i = 0; i < count_instance; i++)
...
void Vulkan_027_GPUCulling::ModelObjectRend::AddFlat3D_AABB()
{
    bool isNeedUpdateBuffer = false;
    int count_instance = this->pModelObject->countInstance;
    for (int i = 0; i < count_instance; i++)
...
void Vulkan_027_GPUCulling::ModelObjectRend::RemoveFlat3D_AABB()
{
    bool isNeedUpdateBuffer = false;
    int count_instance = this->pModelObject->countInstance;
    for (int i = 0; i < count_instance; i++)
...
void Vulkan_027_GPUCulling::ModelObjectRend::AddFlat3D_Sphere()
{
    bool isNeedUpdateBuffer = false;
    int count_instance = this->pModelObject->countInstance;
    for (int i = 0; i < count_instance; i++)
...
void Vulkan_027_GPUCulling::ModelObjectRend::RemoveFlat3D_Sphere()
{
    bool isNeedUpdateBuffer = false;
    int count_instance = this->pModelObject->countInstance;
    for (int i = 0; i < count_instance; i++)
...
void Vulkan_027_GPUCulling::ModelObjectRendIndirect::Destroy()
{
    //Vertex/Index
...
void Vulkan_027_GPUCulling::ModelObjectRendIndirect::CleanupSwapChain()
{
    size_t count = 0;
...
{
    F_Assert(_aRends.size() > 0 && "Vulkan_027_GPUCulling::ModelObjectRendIndirect::SetupVertexIndexBuffer")
    this->aRends.clear();
    this->aRends = _aRends;
    ...
    {
        F_Assert(false && "Vulkan_027_GPUCulling::ModelObjectRendIndirect::SetupVertexIndexBuffer: No vertex data !")
    }
        ...
        this->poIndexBuffer_Data != nullptr)
    {
		...
		{
			F_LogError("*********************** Vulkan_027_GPUCulling::ModelObjectRendIndirect::SetupVertexIndexBuffer: create buffer vertex index failed: [%s] !", this->nameObjectRendIndirect.c_str());
			return;
		}
    }
	else
	{
		...
		{
			F_LogError("*********************** Vulkan_027_GPUCulling::ModelObjectRendIndirect::SetupVertexIndexBuffer: create buffer vertex failed: [%s] !", this->nameObjectRendIndirect.c_str());
			return;
		}
	}
}

void Vulkan_027_GPUCulling::ModelObjectRendIndirect::SetupUniformIndirectCommandBuffer()
{
...
void Vulkan_027_GPUCulling::ModelObjectRendIndirect::UpdateIndirectCommandBuffer()
{
    this->indirectCommandCBs.clear();
...
Vulkan_027_GPUCulling::Vulkan_027_GPUCulling(int width, int height, String name)
...
void Vulkan_027_GPUCulling::setUpEnabledFeatures()
{
    ...
    else
    {
        ...
        F_LogError("*********************** Vulkan_027_GPUCulling::setUpEnabledFeatures: multiDrawIndirect is not supported !");
    }
}

void Vulkan_027_GPUCulling::createDescriptorSetLayout_Custom()
{
    VulkanWindow::createDescriptorSetLayout_Custom();
}

void Vulkan_027_GPUCulling::createCamera()
{
    VulkanWindow::createCamera();

    cameraReset();
}
    void Vulkan_027_GPUCulling::cameraReset()
    {
...
void Vulkan_027_GPUCulling::createLightMain()
{
    lightMainReset();
}
    void Vulkan_027_GPUCulling::lightMainReset()
    {
...
void Vulkan_027_GPUCulling::createShadowLightMain()
{

}


void Vulkan_027_GPUCulling::loadModel_Custom()
{
    createMeshes();
    createTextures();
    createCullInfos();
    ...
    for (int i = 0; i < g_Object_Count; i++)
    {
        ...
        //1> Object
        {
            ...
            //Mesh
            {
                ...
                F_Assert(pMesh != nullptr && "Vulkan_027_GPUCulling::loadModel_Custom")
        ...
        //2> ObjectRend
        {
            ...
            for (size_t j = 0; j < count_mesh_sub_used; j++)
            {
                ...
                F_Assert(indexMeshSub >= 0 && indexMeshSub < count_mesh_sub && "Vulkan_027_GPUCulling::loadModel_Custom")
...
void Vulkan_027_GPUCulling::createIndirectCommands()
{

}

void Vulkan_027_GPUCulling::createCustomCB()
{
    rebuildInstanceCBs(true);
}
void Vulkan_027_GPUCulling::rebuildInstanceCBs(bool isCreateVkBuffer)
{   
    VkDeviceSize bufferSize;
...
void Vulkan_027_GPUCulling::createCustomBeforePipeline()
{
...
void Vulkan_027_GPUCulling::createGraphicsPipeline_Custom()
{
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            String msg = "*********************** Vulkan_027_GPUCulling::createGraphicsPipeline_Custom: Can not find shader used !";
            F_LogError(msg.c_str());
        ...
        //[2] Pipeline Graphics
        {
            ...
            if (pRend->isCanCullingInit)
            {
                ...
                if (pCullInfo != nullptr)
                {
                    ...
                    {
                        String msg = "*********************** Vulkan_027_GPUCulling::createGraphicsPipeline_Custom: [Cull] Can not find shader used !";
                        F_LogError(msg.c_str());
                        throw std::runtime_error(msg.c_str());
                    }
                    ...
                    F_LogInfo("Vulkan_027_GPUCulling::createGraphicsPipeline_Custom: Object: [Cull] [%s] Create pipeline graphics graphics success !", pRend->nameObjectRend.c_str());
                }
            }
        }
    }
}
void Vulkan_027_GPUCulling::createComputePipeline_Custom()
{
    size_t count_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            String msg = "*********************** Vulkan_027_GPUCulling::createComputePipeline_Custom: Can not find shader used !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            String msg = "*********************** Vulkan_027_GPUCulling::createComputePipeline_Custom: Pipeline count is not equal shader count !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
...
void Vulkan_027_GPUCulling::destroyMeshes()
{
...
void Vulkan_027_GPUCulling::createMeshes()
{
    for (int i = 0; i < g_MeshCount; i++)
    {
        ...
        {
            String msg = "*********************** Vulkan_027_GPUCulling::createMeshes: create mesh: [" + nameMesh + "] failed !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg);
        }
        ...
        F_LogInfo("Vulkan_027_GPUCulling::createMeshes: create mesh: [%s], vertex type: [%s], mesh type: [%s], geometry type: [%s], mesh sub count: [%d], path: [%s] success !", 
                  nameMesh.c_str(), nameVertexType.c_str(), nameMeshType.c_str(), nameGeometryType.c_str(), (int)pMesh->aMeshSubs.size(), pathMesh.c_str());
    }
}
Mesh* Vulkan_027_GPUCulling::findMesh(const String& nameMesh)
{
...
void Vulkan_027_GPUCulling::destroyTextures()
{
...
void Vulkan_027_GPUCulling::createTextures()
{
    for (int i = 0; i < g_TextureCount; i++)
    {
        ...
        F_LogInfo("Vulkan_027_GPUCulling::createTextures: create texture: [%s], type: [%s], isRT: [%s], path: [%s] success !", 
                  nameTexture.c_str(), 
                  nameType.c_str(), 
...
VKTexture* Vulkan_027_GPUCulling::findTexture(const String& nameTexture)
{
...
void Vulkan_027_GPUCulling::destroyCullInfos()
{
...
void Vulkan_027_GPUCulling::createCullInfos()
{
...
Vulkan_027_GPUCulling::CullInfo* Vulkan_027_GPUCulling::findCullInfo(const String& nameShader)
{
...
void Vulkan_027_GPUCulling::destroyShaderModules()
{   
...
void Vulkan_027_GPUCulling::createShaderModules()
{
    for (int i = 0; i < g_ShaderCount; i++)
    {
        ...
        F_LogInfo("Vulkan_027_GPUCulling::createShaderModules: create shader, name: [%s], type: [%s], path: [%s] success !", 
                  shaderName.c_str(), shaderType.c_str(), shaderPath.c_str());
    }
}
VkShaderModule Vulkan_027_GPUCulling::findShaderModule(const String& nameShaderModule)
{
                                                          ...
                                                          VKBufferCompute* pCB_Result)
{
    ...
    {   
        ...
        for (uint32_t p = 0; p < count_names; p++)
        {
            ...
            {
                String msg = "*********************** Vulkan_027_GPUCulling::updateDescriptorSets_Graphics: Graphics: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
                F_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
                                                         ...
                                                         VKPipelineCompute* pPipelineCompute)
{
    ...
    for (uint32_t p = 0; p < count_names; p++)
    {
        ...
        {
            String msg = "*********************** Vulkan_027_GPUCulling::createDescriptorSets_Compute: Compute: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
    }  
...
void Vulkan_027_GPUCulling::updateCompute_BeforeRender_Custom(VkCommandBuffer& commandBuffer)
{
    size_t count_object_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_object_rend; i++)
    {
...
void Vulkan_027_GPUCulling::updateCBs_Custom()
{
    //1> Object Rend
...
void Vulkan_027_GPUCulling::updateRenderPass_SyncComputeGraphics(VkCommandBuffer& commandBuffer)
{
    size_t count_object_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_object_rend; i++)
    {
    ...
    void Vulkan_027_GPUCulling::drawMeshShadowMap(VkCommandBuffer& commandBuffer)
    {
...
bool Vulkan_027_GPUCulling::beginRenderImgui()
{
    ImGui_ImplVulkan_NewFrame();
    ImGui_ImplGlfw_NewFrame();
    ImGui::NewFrame();
    static bool windowOpened = true;
    ImGui::Begin("Vulkan_027_GPUCulling", &windowOpened, 0);
    {
        //0> Common
        commonConfig();
...
void Vulkan_027_GPUCulling::modelConfig()
{
...
void Vulkan_027_GPUCulling::endRenderImgui()
{
    VulkanWindow::endRenderImgui();

}

void Vulkan_027_GPUCulling::drawMeshDefault_Custom(VkCommandBuffer& commandBuffer)
{   
...
void Vulkan_027_GPUCulling::drawModelObjectRendCulls(VkCommandBuffer& commandBuffer)
{
...
void Vulkan_027_GPUCulling::drawModelObjectRendCull(VkCommandBuffer& commandBuffer, ModelObjectRend* pRend)
{
...
void Vulkan_027_GPUCulling::drawModelObjectRendIndirect(VkCommandBuffer& commandBuffer, ModelObjectRendIndirect* pRendIndirect)
{
...
void Vulkan_027_GPUCulling::drawModelObjectRend(VkCommandBuffer& commandBuffer, ModelObjectRend* pRend)
{
    ModelObject* pModelObject = pRend->pModelObject;
    MeshSub* pMeshSub = pRend->pMeshSub;
