...
/////////////////////////// ModelMeshSub ////////////////////////
void Vulkan_015_MultiView::ModelMeshSub::Destroy()
{
    //Vertex
...
void Vulkan_015_MultiView::ModelMeshSub::WriteVertexData(std::vector<Vertex_Pos3Color4Normal3Tex2>& aPos3Color4Normal3Tex2,
...
void Vulkan_015_MultiView::ModelMeshSub::WriteIndexData(std::vector<uint32_t>& indexData)
{
    indexData.insert(indexData.end(), indices.begin(), indices.end());
}

/////////////////////////// ModelMesh ///////////////////////////
bool Vulkan_015_MultiView::ModelMesh::AddMeshSub(ModelMeshSub* pMeshSub)
{
...
/////////////////////////// ModelTexture ////////////////////////
void Vulkan_015_MultiView::ModelTexture::UpdateTexture()
{
...
void Vulkan_015_MultiView::ModelTexture::updateNoiseTextureData()
{
    // Perlin noise
...
void Vulkan_015_MultiView::ModelTexture::updateNoiseTexture()
{
...
/////////////////////////// MultiRenderPass /////////////////////
void Vulkan_015_MultiView::FrameBufferAttachment::Init(Vulkan_015_MultiView* pWindow, bool _isDepth)
{
...
void Vulkan_015_MultiView::MultiRenderPass::Init()
{
    ...
    else
    {
        ...
        //2> RenderPass
        {
            ...
            if (!this->pWindow->createVkRenderPass(this->nameRenderPass,
                                                   ...
                                                   this->poRenderPass))
            {
                std::string msg = "Vulkan_015_MultiView::MultiRenderPass::Init: Failed to create renderpass: " + this->nameRenderPass;
        ...
        //3> Framebuffer
        {
            ...
            if (!this->pWindow->createVkFramebuffer(this->nameRenderPass,
                                                    ...
                                                    this->poFrameBuffer))
            {
                std::string msg = "Vulkan_015_MultiView::MultiRenderPass::Init: Failed to create framebuffer: " + this->nameRenderPass;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg);
            }
        }
...
void Vulkan_015_MultiView::MultiRenderPass::CleanupSwapChain()
{
    Destroy();
}

void Vulkan_015_MultiView::MultiRenderPass::RecreateSwapChain()
{
...
void Vulkan_015_MultiView::ModelObjectRendIndirect::CleanupSwapChain()
{
    size_t count = 0;
...
void Vulkan_015_MultiView::ModelObjectRendIndirect::UpdateUniformBuffer()
{
    this->objectCBs.clear();
    this->materialCBs.clear();
    this->tessellationCBs.clear();
...
void Vulkan_015_MultiView::ModelObjectRendIndirect::UpdateIndirectCommandBuffer()
{
    this->indirectCommandCBs.clear();
...
Vulkan_015_MultiView::Vulkan_015_MultiView(int width, int height, std::string name)
...
void Vulkan_015_MultiView::createDescriptorSetLayout_Custom()
{
    VulkanWindow::createDescriptorSetLayout_Custom();
}

void Vulkan_015_MultiView::createRenderPass_Custom()
{
...
void Vulkan_015_MultiView::loadModel_Custom()
{
    createModelMeshes();
    createModelTextures();
...
void Vulkan_015_MultiView::createIndirectCommands()
{

}

void Vulkan_015_MultiView::createCustomCB()
{
    rebuildInstanceCBs(true);
}
void Vulkan_015_MultiView::rebuildInstanceCBs(bool isCreateVkBuffer)
{   
    VkDeviceSize bufferSize;
...
void Vulkan_015_MultiView::createCustomBeforePipeline()
{
...
void Vulkan_015_MultiView::createGraphicsPipeline_Custom()
{
    ...
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            std::string msg = "Vulkan_015_MultiView::createGraphicsPipeline_Custom: Can not find shader used !";
            Util_LogError(msg.c_str());
        ...
        //[2] Pipeline Graphics
        {
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createGraphicsPipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createGraphicsPipeline_Custom: Can not find DescriptorSetLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createGraphicsPipeline_Custom: Can not find PipelineLayout by name: " + pRend->pPipelineGraphics->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createGraphicsPipeline_Custom: Can not find MultiRenderPass by name: " + pRend->pPipelineGraphics->nameRenderPass;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createGraphicsPipeline_Custom: Failed to create pipeline graphics wire frame: " + pRend->nameObjectRend;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createGraphicsPipeline_Custom: Failed to create pipeline graphics: " + pRend->nameObjectRend;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
...
void Vulkan_015_MultiView::createComputePipeline_Custom()
{
    size_t count_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_rend; i++)
    {
        ...
        {
            std::string msg = "Vulkan_015_MultiView::createComputePipeline_Custom: Can not find shader used !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            std::string msg = "Vulkan_015_MultiView::createComputePipeline_Custom: Pipeline count is not equal shader count !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        for (size_t j = 0; j < count_pipeline; j ++)
        {
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createComputePipeline_Custom: Can not find DescriptorSetLayoutNames by name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createComputePipeline_Custom: Can not find DescriptorSetLayout by name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createComputePipeline_Custom: Can not find PipelineLayout by name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createComputePipeline_Custom: Create compute pipeline failed, PipelineLayout name: " + p->nameDescriptorSetLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
...
void Vulkan_015_MultiView::destroyModelMeshes()
{
...
void Vulkan_015_MultiView::createModelMeshes()
{
    for (int i = 0; i < g_Mesh_Count; i++)
    {
        ...
        {
            std::string msg = "Vulkan_015_MultiView::createModelMeshes: create mesh: [" + nameMesh + "] failed !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg);
        }
...
Vulkan_015_MultiView::ModelMesh* Vulkan_015_MultiView::findModelMesh(const std::string& nameMesh)
{
...
void Vulkan_015_MultiView::destroyModelTextures()
{
...
void Vulkan_015_MultiView::createModelTextures()
{
...
Vulkan_015_MultiView::ModelTexture* Vulkan_015_MultiView::findModelTexture(const std::string& nameTexture)
{
...
void Vulkan_015_MultiView::destroyDescriptorSetLayouts()
{
...
void Vulkan_015_MultiView::createDescriptorSetLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayout_Count; i++)
    {
        ...
        for (size_t j = 0; j < count_layout; j++)
        {
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createDescriptorSetLayouts: Wrong DescriptorSetLayout type: " + strLayout;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
...
VkDescriptorSetLayout Vulkan_015_MultiView::findDescriptorSetLayout(const std::string& nameDescriptorSetLayout)
{
...
std::vector<std::string>* Vulkan_015_MultiView::findDescriptorSetLayoutNames(const std::string& nameDescriptorSetLayout)
{
...
VkShaderModule Vulkan_015_MultiView::findShaderModule(const std::string& nameShaderModule)
{
...
bool Vulkan_015_MultiView::createPipelineShaderStageCreateInfos(const std::string& nameShaderVert,
...
bool Vulkan_015_MultiView::createPipelineShaderStageCreateInfos(const std::string& nameShaderComp,
                                                                      VkPipelineShaderStageCreateInfoVector& aStageCreateInfos_Compute,
                                                                      VkPipelineShaderStageCreateInfoMap& mapStageCreateInfos_Compute)
{
    //comp
...
void Vulkan_015_MultiView::destroyPipelineLayouts()
{
...
void Vulkan_015_MultiView::createPipelineLayouts()
{
    for (int i = 0; i < g_DescriptorSetLayout_Count; i++)
    {
...
VkPipelineLayout Vulkan_015_MultiView::findPipelineLayout(const std::string& namePipelineLayout)
{
...
void Vulkan_015_MultiView::destroyMultiRenderPasses()
{
...
void Vulkan_015_MultiView::createMultiRenderPasses()
{    
...
Vulkan_015_MultiView::MultiRenderPass* Vulkan_015_MultiView::findMultiRenderPass(const std::string& nameRenderPass)
{
...
void Vulkan_015_MultiView::createDescriptorSets_Custom()
{
    //1> Object Rend
                                                               ...
                                                               ModelObjectRendIndirect* pRendIndirect)
{
    ...
    {   
        ...
        for (size_t p = 0; p < count_names; p++)
        {
            ...
            {
                std::string msg = "Vulkan_015_MultiView::createDescriptorSets_Graphics: Graphics: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
                Util_LogError(msg.c_str());
                throw std::runtime_error(msg.c_str());
            }
        }
                                                              ...
                                                              ModelObjectRend* pRend)
{
    ...
    for (size_t p = 0; p < count_names; p++)
    {
        ...
        {
            std::string msg = "Vulkan_015_MultiView::createDescriptorSets_Compute: Compute: Wrong DescriptorSetLayout type: " + nameDescriptorSet;
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
    }  
...
void Vulkan_015_MultiView::updateCBs_Custom()
{
    //1> Object Rend
...
void Vulkan_015_MultiView::updateRenderPass_SyncComputeGraphics(VkCommandBuffer& commandBuffer)
{
    size_t count_object_rend = this->m_aModelObjectRends_All.size();
    for (size_t i = 0; i < count_object_rend; i++)
    {
...
bool Vulkan_015_MultiView::beginRenderImgui()
{
    ImGui_ImplVulkan_NewFrame();
    ImGui_ImplGlfw_NewFrame();
    ImGui::NewFrame();
    static bool windowOpened = true;
    ImGui::Begin("Vulkan_015_MultiView", &windowOpened, 0);
    {
        //0> Common
        commonConfig();
...
void Vulkan_015_MultiView::passConstantsConfig()
{
...
void Vulkan_015_MultiView::modelConfig()
{
...
void Vulkan_015_MultiView::endRenderImgui()
{
    VulkanWindow::endRenderImgui();

}

void Vulkan_015_MultiView::updateRenderPass_CustomBeforeDefault(VkCommandBuffer& commandBuffer)
{
    size_t count_render_pass = this->m_aMultiRenderPasses.size();
    for (size_t i = 0; i < count_render_pass; i++)
    {
    ...
    void Vulkan_015_MultiView::drawMeshCustom(VkCommandBuffer& commandBuffer, MultiRenderPass* pRenderPass)
    {
...
void Vulkan_015_MultiView::addRenderPass2ModelObjectRendMap(MultiRenderPass* pRenderPass, ModelObjectRend* pRend)
{   
    if (pRend->isTransparent)
    {
...
void Vulkan_015_MultiView::addRenderPass2ModelObjectRendMap(MultiRenderPass2ObjectRendsMap& mapRP2OR, MultiRenderPass* pRenderPass, ModelObjectRend* pRend)
{
...
void Vulkan_015_MultiView::drawModelObjectRendByRenderPass(VkCommandBuffer& commandBuffer, MultiRenderPass* pRenderPass)
{
...
void Vulkan_015_MultiView::drawModelObjectRendIndirects(VkCommandBuffer& commandBuffer, ModelObjectRendPtrVector& aRends)
{
...
void Vulkan_015_MultiView::drawModelObjectRendIndirect(VkCommandBuffer& commandBuffer, ModelObjectRendIndirect* pRendIndirect)
{
...
void Vulkan_015_MultiView::drawModelObjectRends(VkCommandBuffer& commandBuffer, ModelObjectRendPtrVector& aRends)
{
    size_t count_rend = aRends.size();
    for (size_t i = 0; i < count_rend; i++)
    {
...
void Vulkan_015_MultiView::drawModelObjectRend(VkCommandBuffer& commandBuffer, ModelObjectRend* pRend)
{
    ModelObject* pModelObject = pRend->pModelObject;
...
void Vulkan_015_MultiView::cleanupCustom()
{
...
void Vulkan_015_MultiView::cleanupSwapChain_Custom()
{
    size_t count = this->m_aModelObjects.size();
    for (size_t i = 0; i < count; i++)
    {
