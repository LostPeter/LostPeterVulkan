...
#ifndef _VULKAN_015_MULTI_VIEW_H_
#define _VULKAN_015_MULTI_VIEW_H_

#include "VulkanWindow.h"
#include "VulkanMath.h"
using namespace LostPeter; 

class Vulkan_015_MultiView : public VulkanWindow
{
public:
    Vulkan_015_MultiView(int width, int height, std::string name);
...
public:
    ...
    struct ModelTexture
    {
        ...
        ModelTexture(Vulkan_015_MultiView* _pWindow, 
    ...
    struct FrameBufferAttachment
    {
        ...
        void Destroy(Vulkan_015_MultiView* pWindow)
        {
        ...
        void Init(Vulkan_015_MultiView* pWindow, bool _isDepth);
    };
    struct MultiRenderPass
    {
        ...
        MultiRenderPass(Vulkan_015_MultiView* _pWindow, 
    ...
    struct PipelineGraphics
    {
        ...
        PipelineGraphics(Vulkan_015_MultiView* _pWindow)
            : pWindow(_pWindow)
    ...
    struct PipelineCompute
    {
        ...
        PipelineCompute(Vulkan_015_MultiView* _pWindow)
            : pWindow(_pWindow)
            , nameDescriptorSetLayout("")
            , poDescriptorSetLayoutNames(nullptr)
            , poDescriptorSetLayout(VK_NULL_HANDLE)
    ...
    {
        std::string nameObjectRendIndirect;
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_015_MultiView* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
