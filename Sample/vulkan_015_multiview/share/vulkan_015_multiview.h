...
public: 
    ...
    struct ModelObjectRend
    {
		...
		//Render Pass
		VKMultiRenderPass* poRenderPass;
    ...
    //Load Assets
        ...
        virtual void createDescriptorSets_Custom();
            void createDescriptorSets_Graphics(VkDescriptorSetVector& poDescriptorSets, 
                                               ModelObjectRend* pRend, 
                                               ModelObjectRendIndirect* pRendIndirect);
            void createDescriptorSets_Compute(VKStatePipelineCompute* pStatePipelineCompute, 
                                              ModelObjectRend* pRend);
...
////Draw
    ...
    void drawModelObjectRendView(VkCommandBuffer& commandBuffer, ModelObjectRend* pRend, VKStatePipelineGraphics* pStatePipelineGraphics);
};
