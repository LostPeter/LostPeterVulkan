...
#ifndef _VULKAN_026_FOG_H_
#define _VULKAN_026_FOG_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeterVulkan; 

class Vulkan_026_Fog : public VulkanWindow
{
public:
    Vulkan_026_Fog(int width, int height, String name);
...
public:
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_026_Fog* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
