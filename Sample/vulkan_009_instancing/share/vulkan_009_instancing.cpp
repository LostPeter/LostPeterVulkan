...
void Vulkan_009_Instancing::createPipeline_Custom()
{
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        {
            std::string msg = "Vulkan_009_Instancing::createPipeline_Custom: Failed to create pipeline !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            std::string msg = "Vulkan_009_Instancing::createPipeline_Custom: Failed to create pipeline no depth test !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            std::string msg = "Vulkan_009_Instancing::createPipeline_Custom: Failed to create pipeline no depth write !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            std::string msg = "Vulkan_009_Instancing::createPipeline_Custom: Failed to create pipeline no depth test and write !";
            Util_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
    }
