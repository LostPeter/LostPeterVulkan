...
bool Vulkan_016_Geometry::ModelMeshSub::CreateMeshSub(MeshData& meshData, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
...
bool Vulkan_016_Geometry::ModelMesh::LoadMesh(bool isFlipY, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    ...
    else if (this->typeMesh == Vulkan_Mesh_Geometry)
    {
        ...
        {
            F_LogError("Vulkan_016_Geometry::ModelMesh::LoadMesh: create geometry mesh failed: typeGeometry: [%s] !", Util_GetMeshGeometryTypeName(this->typeGeometryType).c_str());
            return false; 
        }
