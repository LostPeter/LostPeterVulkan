...
bool Vulkan_016_Geometry::ModelMeshSub::CreateMeshSub(FMeshData& meshData, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    ...
    if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tex2)
    {
        ...
        F_LogInfo("Vulkan_016_Geometry::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tex2]: Vertex count: [%d], Index count: [%d] !", 
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tex4)
    {
        ...
        F_LogInfo("Vulkan_016_Geometry::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tex4]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tangent3Tex2)
    {
        ...
        F_LogInfo("Vulkan_016_Geometry::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tangent3Tex2]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    else if (this->poTypeVertex == F_MeshVertex_Pos3Color4Normal3Tangent3Tex4)
    {
        ...
        F_LogInfo("Vulkan_016_Geometry::ModelMeshSub::CreateMeshSub: create mesh sub: [%s] - [%s] success, [Pos3Color4Normal3Tangent3Tex4]: Vertex count: [%d], Index count: [%d] !", 
                  this->nameMeshSub.c_str(),
                  this->nameOriginal.c_str(),
    ...
    {
        F_LogError("Vulkan_016_Geometry::ModelMeshSub::CreateMeshSub: create mesh sub failed: [%s], wrong poTypeVertex !", this->nameMeshSub.c_str());
        return false; 
    }
...
void Vulkan_016_Geometry::ModelMeshSub::WriteVertexData(std::vector<FVertex_Pos3Color4Normal3Tex2>& aPos3Color4Normal3Tex2,
...
bool Vulkan_016_Geometry::ModelMesh::AddMeshSub(ModelMeshSub* pMeshSub)
{
    ...
    {
        F_LogError("Vulkan_016_Geometry::ModelMesh::AddMeshSub: Mesh sub is exist: [%s] !", pMeshSub->nameMeshSub.c_str());
        return false;
    }
...
bool Vulkan_016_Geometry::ModelMesh::LoadMesh(bool isFlipY, bool isTranformLocal, const FMatrix4& matTransformLocal)
{
    //1> Load
    ...
    if (this->typeMesh == F_Mesh_File)
    {
        ...
        {
            F_LogError("Vulkan_016_Geometry::ModelMesh::LoadMesh: load meshes failed: [%s] !", this->pathMesh.c_str());
            return false; 
        }
    }
    else if (this->typeMesh == F_Mesh_Geometry)
    {
        ...
        {
            F_LogError("Vulkan_016_Geometry::ModelMesh::LoadMesh: create geometry mesh failed: typeGeometry: [%s] !", F_GetMeshGeometryTypeName(this->typeGeometryType).c_str());
            return false; 
        }
    ...
    for (int i = 0; i < count_mesh_sub; i++)
    {
        ...
        {
            F_LogError("Vulkan_016_Geometry::ModelMesh::LoadMesh: Create mesh sub failed: [%s] !", nameMeshSub.c_str());
            return false;
        }
        AddMeshSub(pMeshSub);
    }
...
void Vulkan_016_Geometry::createModelMeshes()
{
    for (int i = 0; i < g_MeshCount; i++)
    {
        ...
        F_LogInfo("Vulkan_016_Geometry::createModelMeshes: create mesh: [%s], vertex type: [%s], mesh type: [%s], geometry type: [%s], mesh sub count: [%d], path: [%s] success !", 
...
void Vulkan_016_Geometry::createModelTextures()
{
    for (int i = 0; i < g_TextureCount; i++)
    {
        ...
        F_LogInfo("Vulkan_016_Geometry::createModelTextures: create texture: [%s], type: [%s], isRT: [%s], path: [%s] success !", 
                  nameTexture.c_str(), 
                  nameType.c_str(), 
                                                                   ...
                                                                   VkPipelineShaderStageCreateInfoVector& aStageCreateInfos_Graphics)
{
    //vert
    {
        ...
        {
            F_LogError("Vulkan_016_Geometry::createPipelineShaderStageCreateInfos: Can not find vert shader module: [%s] !", nameShaderVert.c_str());
            return false;
        }
    ...
    if (!nameShaderTesc.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_016_Geometry::createPipelineShaderStageCreateInfos: Can not find tesc shader module: [%s] !", nameShaderTesc.c_str());
            return false;
        }
    ...
    if (!nameShaderTese.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_016_Geometry::createPipelineShaderStageCreateInfos: Can not find tese shader module: [%s] !", nameShaderTese.c_str());
            return false;
        }
    ...
    if (!nameShaderGeom.empty())
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_016_Geometry::createPipelineShaderStageCreateInfos: Can not find geom shader module: [%s] !", nameShaderGeom.c_str());
            return false;
        }
    ...
    //frag
    {
        ...
        if (shaderModule == VK_NULL_HANDLE)
        {
            F_LogError("Vulkan_016_Geometry::createPipelineShaderStageCreateInfos: Can not find frag shader module: [%s] !", nameShaderFrag.c_str());
            return false;
        }
                                                                   ...
                                                                   VkPipelineShaderStageCreateInfoMap& mapStageCreateInfos_Compute)
{
    ...
    if (!nameShaderComp.empty())
    {
        ...
        for (int i = 0; i < count_comp; i++)
        {
            ...
            if (shaderModule == VK_NULL_HANDLE)
            {
                F_LogError("Vulkan_016_Geometry::createPipelineShaderStageCreateInfos: Can not find comp shader module: [%s] !", nameSC.c_str());
                return false;
            }
