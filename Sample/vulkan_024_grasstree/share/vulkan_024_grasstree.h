...
#ifndef _VULKAN_024_GRASS_TREE_H_
#define _VULKAN_024_GRASS_TREE_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeterVulkan; 

class Vulkan_024_GrassTree : public VulkanWindow
{
public:
    Vulkan_024_GrassTree(int width, int height, String name);
...
public:
    ...
    struct ModelObject
    {
        ...
        ModelObject(Vulkan_024_GrassTree* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
