...
public:
	...
	String shaderVertex_Path_Stencil;
	String shaderFragment_Path_Stencil;
	VKShader* pShaderVertex_Stencil;
	VKShader* pShaderFragment_Stencil;
	
	String shaderVertex_Path_Outline;
	String shaderFragment_Path_Outline;
	VKShader* pShaderVertex_Outline;
	VKShader* pShaderFragment_Outline;
