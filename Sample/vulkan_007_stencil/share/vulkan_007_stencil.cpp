...
Vulkan_007_Stencil::Vulkan_007_Stencil(int width, int height, String name)
	...
	, pShaderVertex_Stencil(nullptr)
	, pShaderFragment_Stencil(nullptr)
	...
	, pShaderFragment_Outline(nullptr)
{
    ...
    this->shaderVertex_Path_Stencil = "Assets/Shader/pos3_color4_normal3_tex2_ubo.vert.spv";
    this->shaderFragment_Path_Stencil = "Assets/Shader/pos3_color4_normal3_tex2_ubo.frag.spv";
    this->shaderVertex_Path_Outline = "Assets/Shader/pos3_color4_normal3_tex2_ubo_outline.vert.spv";
    this->shaderFragment_Path_Outline = "Assets/Shader/pos3_color4_normal3_tex2_ubo_outline.frag.spv";
...
bool Vulkan_007_Stencil::loadModel_VertexIndex(ModelObject* pModelObject, bool isFlipY, bool isTransformLocal, const FMatrix4& matTransformLocal)
{
        ...
        pModelObject->poIndexBuffer_Data != nullptr)
    {
		...
		{
			F_LogError("*********************** Vulkan_007_Stencil::loadModel_VertexIndex: create buffer vertex index failed: [%s] !", pModelObject->nameModel.c_str());
			return false;
		}
	}
	else 
	{
		...
		{
			F_LogError("*********************** Vulkan_007_Stencil::loadModel_VertexIndex: create buffer vertex failed: [%s] !", pModelObject->nameModel.c_str());
			return false;
		}
	}
...
void Vulkan_007_Stencil::createGraphicsPipeline_Custom()
{
    ...
    FUtilString::SplitFileName(this->shaderVertex_Path_Stencil, nameVertexShader_Stencil, namePathBase);
	this->pShaderVertex_Stencil = createShader(nameVertexShader_Stencil, this->shaderVertex_Path_Stencil, F_Shader_Vertex);
	String nameFragmentShader_Stencil;
    FUtilString::SplitFileName(this->shaderFragment_Path_Stencil, nameFragmentShader_Stencil, namePathBase);
	this->pShaderFragment_Stencil = createShader(nameFragmentShader_Stencil, this->shaderFragment_Path_Stencil, F_Shader_Fragment);

	String nameVertexShader_Outline;
    FUtilString::SplitFileName(this->shaderVertex_Path_Outline, nameVertexShader_Outline, namePathBase);
	this->pShaderVertex_Outline = createShader(nameVertexShader_Outline, this->shaderVertex_Path_Outline, F_Shader_Vertex);
	String nameFragmentShader_Outline;
    FUtilString::SplitFileName(this->shaderFragment_Path_Outline, nameFragmentShader_Outline, namePathBase);
	this->pShaderFragment_Outline = createShader(nameFragmentShader_Outline, this->shaderFragment_Path_Outline, F_Shader_Fragment);
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        pModelObject->poStatePipelineGraphics_Stencil = createStatePipelineGraphics(nameStatePipelineGraphics_Stencil,
																					...
																					this->pShaderVertex_Stencil,
																					nullptr,
																					nullptr,
																					nullptr,
																					this->pShaderFragment_Stencil,
																					this->typeVertex,
																					false, 0, 3,
        ...
        {
            String msg = "*********************** Vulkan_007_Stencil::createGraphicsPipeline_Custom: Failed to create pipeline stencil, name: " + nameStatePipelineGraphics_Stencil;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            String msg = "*********************** Vulkan_007_Stencil::createGraphicsPipeline_Custom: Failed to create pipeline outline, name: " + nameStatePipelineGraphics_Outline;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
    }
...
{
	F_DELETE(this->pShaderVertex_Stencil)
    F_DELETE(this->pShaderFragment_Stencil)
