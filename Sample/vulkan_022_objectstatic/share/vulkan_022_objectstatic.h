...
#ifndef _VULKAN_022_OBJECT_STATIC_H_
#define _VULKAN_022_OBJECT_STATIC_H_

#include "VulkanWindow.h"
#include "FMath.h"
using namespace LostPeterVulkan; 

class Vulkan_022_ObjectStatic : public VulkanWindow
{
public:
    Vulkan_022_ObjectStatic(int width, int height, String name);
...
public:
    ...
    {
        //Window
        Vulkan_022_ObjectStatic* pWindow;
        int index;
        ...
        ModelObject(Vulkan_022_ObjectStatic* _pWindow,
                    int _index)
            //Window
            : pWindow(_pWindow)
            , index(_index)
