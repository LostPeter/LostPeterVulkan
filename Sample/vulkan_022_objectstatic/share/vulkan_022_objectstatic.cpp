...
void Vulkan_022_ObjectStatic::destroyShaders()
{   
...
void Vulkan_022_ObjectStatic::createShaders()
{
    for (int i = 0; i < g_ShaderCount; i++)
    {
        ...
        F_LogInfo("Vulkan_022_ObjectStatic::createShaders: create shader, name: [%s], type: [%s], path: [%s] success !", 
                  shaderName.c_str(), shaderType.c_str(), shaderPath.c_str());
    }
}
VKShader* Vulkan_022_ObjectStatic::findShader(const String& nameShader)
{
