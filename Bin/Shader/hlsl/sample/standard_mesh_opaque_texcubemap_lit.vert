...
VSOutput_Pos4Color4Normal3TexCood3 main(VSInput_Pos3Color4Normal3TexCood2 input, 
                                        uint viewIndex : SV_ViewID,
                                        uint instanceIndex : SV_InstanceID)
{
    VSOutput_Pos4Color4Normal3TexCood3 output = (VSOutput_Pos4Color4Normal3TexCood3)0;
