...
VSOutput_Pos4Color4Normal3Tangent3TexCood2 main(VSInput_Pos3Color4Normal3Tangent3TexCood2 input, 
                                                uint viewIndex : SV_ViewID,
                                                uint instanceIndex : SV_InstanceID)
{
    VSOutput_Pos4Color4Normal3Tangent3TexCood2 output = (VSOutput_Pos4Color4Normal3Tangent3TexCood2)0;
