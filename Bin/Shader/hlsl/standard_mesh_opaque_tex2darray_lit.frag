...
[[vk::binding(4)]] Texture2DArray textureArray      : register(t1);
...
float4 main(VSOutput input) : SV_TARGET
{
    ...
    //Texture
    float3 colorTexture = textureArray.Sample(textureSampler, float3(input.inTexCoord, mat.indexTextureArray)).rgb;
    //VertexColor
