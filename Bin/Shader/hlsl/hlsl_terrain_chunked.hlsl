...
#ifndef _HLSL_TERRAIN_CHUNKED_
#define _HLSL_TERRAIN_CHUNKED_
...
///////////////////////////////// Height/Normal //////////////////////////////////////////
float TerrainChunked_GetHeightFromHeightMap(Texture2D textureHeightMap,
											float xPerf,
											float zPerf,
											float terrainStart,
											float terrainMax)
...
float3 TerrainChunked_GetNormalFromNormalMap(Texture2D textureNormalMap,
											 float xPerf,
											 float zPerf)
{
    int2 texDim;
...
///////////////////////////////// Splat //////////////////////////////////////////////////
float2 TerrainChunked_GetSplatUV2BySplatLayer(TerrainChunkedConstants tc, 
											  float2 uv,
											  int nLayer)
{
    TerrainChunkedSplatConstants layer = tc.aSplats[nLayer];
...
void TerrainChunked_GetSampleMask(Texture2DArray texture2DArrayMask,
...
float4 TerrainChunked_GetSplatControl(Texture2DArray texture2DArrayControl,
...
void TerrainChunked_SplatMapMix(Texture2DArray texture2DArrayDiffuse,
