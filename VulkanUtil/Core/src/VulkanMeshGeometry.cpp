...
namespace LostPeter
{
    float VulkanMeshGeometry::s_fPI_Half = glm::pi<float>() / 2.0f;
    float VulkanMeshGeometry::s_fPI = glm::pi<float>();
    float VulkanMeshGeometry::s_fPI_Two = glm::pi<float>() * 2.0f;
	...
	void VulkanMeshGeometry::CreateBox(MeshData& meshData, 
								 float width, 
								 float height, 
								 float depth, 
	...
	void VulkanMeshGeometry::subdivide(MeshData& meshData)
	{
	...
	MeshVertex VulkanMeshGeometry::midPoint(const MeshVertex& v0, const MeshVertex& v1)
	{
		glm::vec3 p0 = v0.pos;
		glm::vec3 p1 = v1.pos;
	...
	void VulkanMeshGeometry::buildCylinderTopCap(float bottomRadius, float topRadius, float height, uint32 sliceCount, uint32 stackCount, MeshData& meshData)
	{
	...
	void VulkanMeshGeometry::buildCylinderBottomCap(float bottomRadius, float topRadius, float height, uint32 sliceCount, uint32 stackCount, MeshData& meshData)
	{
		// 
		// Build bottom cap.
		//
