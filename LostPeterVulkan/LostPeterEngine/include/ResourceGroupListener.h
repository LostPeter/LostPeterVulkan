...
namespace LostPeterEngine
{
    ...
    public:
        //Script
		virtual void ResourceGroupScriptingStarted(const String& strGroupName, uint32 nScriptCount) = 0;	
		...
		//Resource Load
		virtual void ResourceGroupLoadStarted(const String& strGroupName, uint32 nResourceCount) = 0;	
		...
		//Resource Prepare
		virtual void ResourceGroupPrepareStarted(const String& strGroupName, uint32 nResourceCount) {}		
