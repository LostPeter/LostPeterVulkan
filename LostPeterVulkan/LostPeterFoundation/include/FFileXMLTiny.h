...
namespace LostPeterFoundation
{
	...
	public:
		...
		static bool ParserSize(TiXmlElement* pElement, const char* szItemName, FSize& size);
		static bool ParserPoint(TiXmlElement* pElement, const char* szItemName, FPoint& point);
		...
		static void	SaveSize(TiXmlElement* pElement, const char* szItemName, const FSize& size);
		static void	SavePoint(TiXmlElement* pElement, const char* szItemName, const FPoint& point);
